...
<%
    ...
    if (id != null && !id.isEmpty()) {
        try {
            ...
            // Update the status of the card application to 'Rejected'
            String updateQuery = "UPDATE card_applications SET status = 'Rejected' WHERE id = ?";
...
%>
            <script>
                alert('Card application with ID <%= id %> has been rejected successfully!');
